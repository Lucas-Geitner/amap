...
(function () { return __awaiter(_this, void 0, void 0, function () {
    var _a, schema, executor, server;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0: return [4 /*yield*/, gateway.load()];
            case 1:
                _a = _b.sent(), schema = _a.schema, executor = _a.executor;
                server = new ApolloServer({ schema: schema, executor: executor });
